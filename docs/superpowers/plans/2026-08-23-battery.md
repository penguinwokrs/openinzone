...
### Task 4: Watch filters

**Files:**
- Create: `src/OpenInzone.Cli/WatchFilter.cs`
- Modify: `src/OpenInzone.Cli/Program.cs`
- Test: `tests/OpenInzone.Core.Tests/Output/WatchFilterTests.cs`

**Interfaces:**
- Consumes: `EventReport` and both renderers from Tasks 2 and 3.
- Produces: `OpenInzone.Cli.WatchFilter` (internal static) with `public static bool TryParse(string[] words, out HashSet<EventId> events, out string? error)`.
