...
/// </remarks>
public sealed class InzoneBudsDevice : IDisposable
{
    ...
    private InzoneBudsDevice(HidDeviceInfo info)
    {
        DeviceInfo = info;
    ...
    public static InzoneBudsDevice Open(string? devicePath = null)
    {
        if (devicePath is not null)
        {
            ...
            return new InzoneBudsDevice(match);
        }
        ...
        return new InzoneBudsDevice(devices[0]);
    }
